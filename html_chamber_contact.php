...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Chamber Consulting Submission";
    ...
    $title = $_POST['title']; 
    $org = $_POST['org']; // required
    $email_from = $_POST['email']; // required
    $phone = $_POST['phone']; 
    $comments = $_POST['message']; 
    $spamtest = $_POST['phone_alt']; // if this is filled in, it's a bot (since it's not displayed via css).
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Org:   ".clean_string($org)."\n";
